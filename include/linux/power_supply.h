...
enum {
	...
	POWER_SUPPLY_STATUS_QUICK_CHARGING_PLUS,
	POWER_SUPPLY_STATUS_QUICK_FULL,
	POWER_SUPPLY_STATUS_QUICK_FULL_PLUS,
	POWER_SUPPLY_STATUS_THERMAL_ALERT,
	POWER_SUPPLY_STATUS_THERMAL_ALERT_CABLE_OUT,
};
...
enum {
	POWER_SUPPLY_CHARGING_DISABLED_PMI,
	POWER_SUPPLY_CHARGING_DISABLED_RT,
	POWER_SUPPLY_CHARGING_ENABLED_PMI,
	POWER_SUPPLY_CHARGING_ENABLED_RT,
};

enum {
	POWER_SUPPLY_PD_PORT_NONE,
	POWER_SUPPLY_PD_PORT_NONE_PMI,
	POWER_SUPPLY_PD_PORT_NONE_RT,
	POWER_SUPPLY_PD_PORT_PMI,
	POWER_SUPPLY_PD_PORT_RT,
};
#endif
