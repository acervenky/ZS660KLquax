...
void asus_init_state(void){
	...
	uint16_t er2_trigger5_puls_dur = 0xb;//the pulse width bigger than 1us
	uint16_t er2_trig5_control = 0x2; //magic number from sentons
	uint16_t er1_trig3_control = 0x0600; //magic number from sentons
	...
	if(g_ASUS_hwID >= ZS660KL_ER2){
		GRIP_TAP_LINK_VIBRATOR = 0x503; //Trigger 1 & 2 => Trigger 5
		write_register(snt8100fsr_g, REGISTER_TIRGGER5_PULSE_DUR, &er2_trigger5_puls_dur);
		write_register(snt8100fsr_g, REGISTER_TIRGGER5_CONTROL, &er2_trig5_control);
	...
	set_tap_gesture(0, TAP0_BIT0, 0);
	set_tap_gesture(0, TAP0_BIT1, 1);
	set_tap_gesture(0, TAP0_BIT2, 2);
	set_tap_gesture(0, TAP0_BIT3, 3);
	set_tap_gesture(0, TAP0_BIT4, 4);
	set_tap_gesture(0, TAP0_BIT5, 5);
	set_tap_gesture(0, TAP0_BIT6, 6);
	set_tap_gesture(0, TAP0_BIT7, 7);
	
	set_tap_gesture(1, TAP1_BIT0, 0);
	set_tap_gesture(1, TAP1_BIT1, 1);
	set_tap_gesture(1, TAP1_BIT2, 2);
	set_tap_gesture(1, TAP1_BIT3, 3);
	set_tap_gesture(1, TAP1_BIT4, 4);
	set_tap_gesture(1, TAP1_BIT5, 5);
	set_tap_gesture(1, TAP1_BIT6, 6);
	set_tap_gesture(1, TAP1_BIT7, 7);
	/*
	...
	*/
	...
	set_sq_gesture(0, SQ1_BIT0, 0);
	set_sq_gesture(0, SQ1_BIT1, 1);
	set_sq_gesture(0, SQ1_BIT2, 2);
	set_sq_gesture(0, SQ1_BIT3, 3);
	set_sq_gesture(0, SQ1_BIT4, 4);
	set_sq_gesture(0, SQ1_BIT5, 5);
	set_sq_gesture(0, SQ1_BIT6, 6);
	set_sq_gesture(0, SQ1_BIT7, 7);
	set_sq_gesture(0, SQ1_BIT8, 8);
	
	//get_sq_gesture(0, SQ1_BIT0, 0, 10);
	
	set_sq_gesture(1, SQ2_BIT0, 0);
	set_sq_gesture(1, SQ2_BIT1, 1);
	set_sq_gesture(1, SQ2_BIT2, 2);
	set_sq_gesture(1, SQ2_BIT3, 3);
	set_sq_gesture(1, SQ2_BIT4, 4);
	set_sq_gesture(1, SQ2_BIT5, 5);
	set_sq_gesture(1, SQ2_BIT6, 6);
	set_sq_gesture(1, SQ2_BIT7, 7);
	set_sq_gesture(1, SQ2_BIT8, 8);
	...
	set_slide_gesture(0, &SLIDE0_BIT1, 1);
	set_slide_gesture(0, &SLIDE0_BIT2, 2);
	set_slide_gesture(0, &SLIDE0_BIT3, 3);
	set_slide_gesture(0, &SLIDE0_BIT4, 4);
	set_slide_gesture(0, &SLIDE0_BIT5, 5);

	set_slide_gesture(1, &SLIDE1_BIT0, 0);
	set_slide_gesture(1, &SLIDE1_BIT1, 1);
	set_slide_gesture(1, &SLIDE1_BIT2, 2);
	set_slide_gesture(1, &SLIDE1_BIT3, 3);
	set_slide_gesture(1, &SLIDE1_BIT4, 4);
	set_slide_gesture(1, &SLIDE1_BIT5, 5);
	//get_slide_gesture(0, SLIDE0_BIT0, 0, 13);
	
	set_swipe_gesture(0, &SWIPE1_BIT0, 0);
	set_swipe_gesture(0, &SWIPE1_BIT1, 1);
	set_swipe_gesture(0, &SWIPE1_BIT2, 2);
	set_swipe_gesture(0, &SWIPE1_BIT3, 3);
	set_swipe_gesture(0, &SWIPE1_BIT4, 4);
	
	set_swipe_gesture(1, &SWIPE2_BIT0, 0);
	set_swipe_gesture(1, &SWIPE2_BIT1, 1);
	set_swipe_gesture(1, &SWIPE2_BIT2, 2);
	set_swipe_gesture(1, &SWIPE2_BIT3, 3);
	set_swipe_gesture(1, &SWIPE2_BIT4, 4);
...
*/
 static void trig_wq_func1(struct work_struct *work) {
	 //struct trig_work_s *w = (struct trig_work_s*) work;
	 int gpio_val = 0;
	 gpio_val = gpio_get_value(TRIG0_GPIO);
	 PRINT_FUNC();
 ...
 static void trig_wq_func2(struct work_struct *work) {
	 //struct trig_work_s *w = (struct trig_work_s*) work;
	 int gpio_val = 0;
	 gpio_val = gpio_get_value(TRIG1_GPIO);
	 PRINT_FUNC();
	 MUTEX_LOCK(&snt8100fsr_g->tap_lock);
 ...
 static void trig_wq_func3(struct work_struct *work) {
	 //struct trig_work_s *w = (struct trig_work_s*) work;
	 int gpio_val = 0;
	 gpio_val = gpio_get_value(TRIG2_GPIO);
	 PRINT_FUNC();
	 MUTEX_LOCK(&snt8100fsr_g->tap_lock);
...
static void Grip_check_K_and_frame(){
	...
	if(!mutex_is_locked(&snt8100fsr_g->ap_lock)){
		PRINT_INFO("ap_lock is unlock");
	}else{
		PRINT_INFO("ap_lock is lock");
	}
	if(!mutex_is_locked(&snt8100fsr_g->sb_lock)){
		PRINT_INFO("sb_lock is unlock");
	}else{
		PRINT_INFO("sb_lock is lock");
	}
	if(!mutex_is_locked(&snt8100fsr_g->tap_lock)){
		PRINT_INFO("tap_lock is unlock, fw_loading_status=%d", fw_loading_status);
	}else{
		PRINT_INFO("sb_lock is lock");
	}
	finish_boot = 1;
