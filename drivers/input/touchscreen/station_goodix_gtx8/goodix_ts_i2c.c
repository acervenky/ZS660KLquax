...
#define TS_DT_COMPATIBLE "goodix_station,gt9886"
#define TS_DRIVER_NAME "station_goodix_i2c"
...
extern int ec_i2c_pd_set_diplay_id(char display_id);
	...
	const struct i2c_device_id *dev_id)
{
	...
	ts_device->name = "GTx5 Station TouchDevcie";
