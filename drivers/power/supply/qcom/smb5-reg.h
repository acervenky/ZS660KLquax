...
#define CHGR_PRE_CHARGE_CURRENT_CFG		(CHGR_BASE + 0x60)	// ASUS BSP +++

#define CHGR_FAST_CHARGE_CURRENT_CFG_REG	(CHGR_BASE + 0x61)

#define CHGR_TCCC_CHARGE_CURRENT_TERMINATION_CFG	(CHGR_BASE + 0x63)	// ASUS BSP +++
...
#define AICL_FAIL_BIT				BIT(1)		//ASUS BSP +++
...
#define DCDC_VSYSMIN_CFG		(DCDC_BASE + 0x83)		// ASUS BSP +++
...
#define TYPE_C_LEGACY_CABLE_CFG_REG		(TYPEC_BASE + 0x5A)	// ASUS BSP +++
#define LEGACY_CABLE_DET_WINDOW_MASK	GENMASK(2, 1)
#define EN_LEGACY_CABLE_DETECTION_BIT	BIT(0)
...
#define SKIN_L_THRESHOLD_LSB_REG		(MISC_BASE + 0XB7)
